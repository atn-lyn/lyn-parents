...
public class UserInfo implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            ...
            && (this.getDirectLeader() == null ? other.getDirectLeader() == null : this.getDirectLeader().equals(other.getDirectLeader()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDirectLeader() == null) ? 0 : getDirectLeader().hashCode());
